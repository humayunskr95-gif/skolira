...
<div class="p-4 md:p-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-3">
        ...
        <h1 class="text-2xl font-bold flex items-center gap-2">
            🏨 Hostel Super Management
        </h1>

        <div class="flex gap-2 flex-wrap">

            <a href="{{ route('school_admin.hostel_super.create') }}"
               class="bg-indigo-600 text-white px-4 py-2 rounded-lg">
                ➕ Add
            </a>

            <a href="{{ route('school_admin.hostel_super.export') }}"
        ...
        <table class="w-full text-sm">
            ...
            @forelse($users as $index => $u)
                ...
                <tr class="border-t hover:bg-gray-50">
                    ...
                    <!-- STATUS -->
                    <td class="p-3">
                        <form method="POST" action="{{ route('school_admin.hostel_super.toggle',$u->id) }}">
                            @csrf
                    ...
                    <td class="p-3 text-center relative">
                        ...
                        <div class="relative inline-block">
                            ...
                            <div id="dropdown-{{ $u->id }}"
                                ...
                                <a href="{{ route('school_admin.hostel_super.view',$u->id) }}"
                                   class="block px-3 py-2 hover:bg-gray-100">👁 View</a>

                                <a href="{{ route('school_admin.hostel_super.edit',$u->id) }}"
                                   class="block px-3 py-2 hover:bg-gray-100">✏️ Edit</a>

                                <!-- Block / Unblock -->
                                <form method="POST"
                                      action="{{ route('school_admin.hostel_super.toggle',$u->id) }}">
                                    @csrf
                                ...
                                <!-- Delete -->
                                <form method="POST"
                                      action="{{ route('school_admin.hostel_super.delete',$u->id) }}">
                                    @csrf
                                    @method('DELETE')
